        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground font-light max-w-3xl mx-auto leading-relaxed">
              What sets me apart is my positive mindset, collaborative spirit,
              and energetic approach to work. Colleagues often describe me as
              friendly, social, and highly motivated.
            </p>
          </div>
              ...
              <Card className="p-8 bg-card border-border shadow-lg">
                ...
                <div className="space-y-4 text-foreground/80 font-light leading-relaxed">
                  <p>
                    ...
                    with specialization in Pharmacology and Science-Based
                    Business.
                  </p>
                  <p>
                    Over a decade of experience spanning{" "}
                    <strong className="font-medium text-primary">
                      Clinical Operations
                    </strong>{" "}
                    and
                    ...
                    , including leadership roles at industry-leading companies.
                  </p>
                  <p>
                    Most recently served as{" "}
                    <strong className="font-medium text-primary">
                      Study Country Lead at Sanofi
                    </strong>{" "}
                    and previously as{" "}
                    <strong className="font-medium text-primary">
                      Medical Advisor at Teva Pharmaceuticals
                    </strong>
                    .
                  </p>
                </div>
