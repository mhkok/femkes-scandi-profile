        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground font-light max-w-3xl mx-auto leading-relaxed">
              ...
              beyond. Let's discuss how I can contribute to your team's success
            ...
            <div className="space-y-8 animate-slide-up">
              <div>
                ...
                <p className="text-foreground/80 font-light leading-relaxed mb-8">
                  I'd love to hear from you. If you're looking for a dedicated
                  Medical Affairs professional, I'm always open to meaningful
                  conversations.
                </p>
              </div>
          ...
          <div className="mt-16 text-center animate-fade-in">
            <div className="bg-sage-green/10 rounded-2xl p-8 max-w-4xl mx-auto">
              ...
              <p className="text-lg text-foreground/80 font-light leading-relaxed mb-6">
                I bring over a decade of pharmaceutical expertise, a
                collaborative spirit, and genuine passion for improving patient
                outcomes. Let's explore how we can work together.
              </p>
              <div className="flex justify-center gap-4">
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.linkedin.com/in/femke--schepers/",
                      "_blank",
                    )
                  }
                >
