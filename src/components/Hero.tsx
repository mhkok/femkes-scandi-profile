...
export default function Hero() {
  const generateCV = () => {
    ...
    pdf.text('MSc Bio-Pharmaceutical Sciences | Clinical Operations & Medical Affairs Expert', 20, yPos);
    yPos += 8;
    
    pdf.setFontSize(10);
    pdf.text('Stockholm | +46 (0)761126968 | femkeschepers@gmail.com | Dutch Nationality', 20, yPos);
    yPos += 15;
    ...
    pdf.setFont('helvetica', 'normal');
    pdf.setFontSize(10);
    pdf.text('Gastroenterology • Neurology • Vaccines • Cardiology • Drug Repurposing', 20, yPos);
    yPos += 15;
    ...
    const experiences = [
      ...
      },
      {
        ...
        highlights: ['Same Medical Advisor position as previous role but located in Sweden']
      },
      {
        title: 'Medical Advisor',
        company: 'Teva Pharmaceuticals',
    ...
    pdf.setFontSize(10);
    pdf.setTextColor(60, 60, 60);
    const interests = 'Race & Gravel Biking, Field Hockey, Sailing (Yngling World Championship), Surfing, Skiing, Tennis, Rowing (Ringvaart Regatta 100km), Flute (D degree qualified)';
